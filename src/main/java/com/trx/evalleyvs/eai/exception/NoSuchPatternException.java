 ...
 */
public class NoSuchPatternException extends ServiceException {
	/** 발생한 실재 Exception */
	 ...
	 */
    public NoSuchPatternException(String message, Exception exception) {
        super(message);
   ...
   /** 
	 ...
	 *	@param	Excetpion	발생한 Exception
	 */
    public NoSuchPatternException(Exception exception) {
        this(null, exception);
