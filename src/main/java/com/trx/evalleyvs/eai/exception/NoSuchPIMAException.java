 ...
 *  @author 	bmchae
 */
public class NoSuchPIMAException extends ServiceException {
	/** 발생한 실재 Exception */
	 ...
	 */
    public NoSuchPIMAException(String message, Exception exception) {
        super(message);
   ...
   /** 
	 ...
	 *	@param	message	Excetpion message
	 */
    public NoSuchPIMAException(String message) {
        this(message, null);
	 ...
	 *	@param	Excetpion	발생한 Exception
	 */
    public NoSuchPIMAException(Exception exception) {
        this(null, exception);
